...
(() => {
  ...
  const steps = [
    ...
    { section: 'fonts', title: '每款字体都有自己的加粗和颜色', target: '#manage-fonts', location: '顶部 T → 字体管理器；设置 → 背景管理器', text: '内置五款 Shell 字体，可从在线字体库选择 30 款字体，也可导入字体和背景。每张字体卡片单独保存加粗与文字颜色，支持预设、RGB 和 HEX。', bullets: ['选择当前字体立即预览；字号按 0.5 px 调整，面板可拖动。', '背景可以自定义并调整强度，文字的 ANSI 颜色仍由远程程序决定。'] },
