...
"${dengshell_docker[@]}" run --rm --platform linux/amd64 --user "$(id -u):$(id -g)" \
  ...
  -e DENGSHELL_BUILDER_ID="$dengshell_image_id" -e GOOS=linux -e GOARCH=amd64 -e GOAMD64=v1 -e CGO_ENABLED=1 \
