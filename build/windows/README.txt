DengShell v0.01 r26 · Windows 10/11 x64
...
R20 以来累计增加：FinalShell 导入、命令参数与可选回车、命令／分组拖动排序、跨服务器多标签／多编辑窗口、5 套界面字体与文字颜色、Bash/Zsh/Fish 兼容和 Ed25519 更新签名。完整更新见 CHANGELOG.md。
