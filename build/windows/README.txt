DengShell v0.01 R50 · Windows 10/11 x64
...
R20～R50 累计更新：IBM Plex Sans SC 界面字体与五款 Shell 字体、20/30 款在线字体库、分组背景色与三次确认删除、编辑器与列表精简、SSH 初始化与提示符修复、默认网卡选择改进。完整更新见 CHANGELOG.md。
